...
const navigation = [
    { name: 'Home', href: '/portal', icon: 'home', activePattern: /^\/portal$/ },
    { name: 'Scans', href: '/portal/scans', icon: 'scan', activePattern: /^\/portal\/scans/ },
    { name: 'Games', href: '/portal/games', icon: 'games', activePattern: /^\/portal\/games/ },
    { name: 'Merch', href: '/portal/merch', icon: 'shirt', activePattern: /^\/portal\/merch/ },
    { name: 'Referrals', href: '/portal/referrals', icon: 'cash', activePattern: /^\/portal\/referrals/ },
];
